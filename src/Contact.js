      ...
      <div id="contacto" className="bg-orange-100 flex">
        <div className="w-2/3 ">
          <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <form
              action="https://formsubmit.co/115da6b77442ce173004923dad844dd4"
              method="POST"
              className="space-y-8"
            >
              <div>
        ...
        <div className="w-1/3">
          ...
          <div className="flex items-end translate-y-[-100%] -mx-12 max-sm:scale-[60%] max-sm:-mx-[295%] max-[780px]:-mx-[180%] max-lg:-mx-[150%] max-xl:-mx-[100%] max-[1450px]:-mx-[60%] max-sm:w-fit space-x-4 ">
            <div className="btn join-item ">
              ...
              <p>
                {" "}
                <a href="https://wa.me/56997843280"> +56 9 9748 3280 </a>{" "}
              </p>
            </div>
            ...
            <div className="btn join-item">
              ...
              <p>
                {" "}
                <a href="https://instagram.com/micaravancerai">
                  {" "}
                  @micaravancerai{" "}
                </a>{" "}
              </p>
            ...
            <div className="btn join-item">
              <p>
                {" "}
                <a href="mailto:m.a.chamorro.o@gmail.com">
                  {" "}
                  m.a.chamorro.o@gmail.com{" "}
                </a>{" "}
              </p>
            </div>
          </div>
